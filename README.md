...
Please follow the links for each Atom package for installation instructions. Atom also has straightforward instructions on adding packages here: [Atom packages](https://atom.io/docs/v1.0.11/using-atom-atom-packages)
